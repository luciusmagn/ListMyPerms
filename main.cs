...
namespace ListMyPerms
{
    ...
    public class ListMyPerms : TerrariaPlugin
    {
        ...
        {
            get { return "Lists permissions of all commands."; }
        }

        public ListMyPerms(Main game)
            : base(game)
        {
        }
        ...
        public void ListPerms(CommandArgs args)
        {
            ...
            {
                Console.WriteLine("****Page 1 out of " + (Commands.ChatCommands.Count / 50).ToString() + "****");
            }
            ...
            try
            {
                ...
                foreach (var command in Commands.ChatCommands)
                {
                    ...
                    if (command.Name.IndexOf(args.Parameters[0]) != -1)
                    {
                        ...
                        {
                            args.Player.SendInfoMessage("no permissions :" + command.Name);
